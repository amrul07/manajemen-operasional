    ...
    <>
      {value.loadingGet ? (
        ...
        <MainCard
          ...
          content={false}
          sx={{
            bgcolor: 'primary.dark', // background
            color: '#fff',
            overflow: 'hidden',
            position: 'relative',
            '&>div': {
            ...
            '&:after': {
              ...
              width: 210,
              height: 210,
              background: theme.vars.palette.primary[800], // gradasi kanan
              borderRadius: '50%',
              top: { xs: -85 },
              right: { xs: -95 }
            },
            '&:before': {
              ...
              width: 210,
              height: 210,
              background: theme.vars.palette.primary[800], // gradasi kiri
              borderRadius: '50%',
              top: { xs: -125 },
              right: { xs: -15 },
              opacity: 0.5
                  ...
                  <Box>
                    <Stack direction="row" sx={{ alignItems: 'center' }}>
                      ...
                      <Poppins sx={{ fontSize: '2.125rem', fontWeight: 500, mr: 1, mt: 1.75, mb: 0.75 }}>
                        {value?.data.totalAbsensiHariIni} {/* title jumlah absen */}
                      </Poppins>
